...
$idprevision=$_GET['updateid'];
$sql="select * from `previsions` where idprevision=$idprevision";
...
if (isset($_POST['updateprevision'])) {
    $refpromotion = $_POST['refpromotion'];
    $montant = $_POST['montant'];
    $refannee=$_POST['refannee'];
    $sql = " UPDATE `previsions` SET `idprevision`='$idprevision',`refpromotion`='$refpromotion',`montant`='$montant',`refannee`='$refannee' WHERE `idprevision`='$idprevision'";
    $result = mysqli_query($con, $sql);
    if ($result) {
        echo "data insert";
...
<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="students.html">Prevision</a></li>
<li class="breadcrumb-item active">All Prevision</li>
</ul>
</div>
</div>
</div>
...
<button type="submit" name="updateprevision" class="btn btn-info waves-effect waves-light"> Update Promotion</button>
</form>
</div>
</div>
</div>
