...
<?php
    ...
    $coderecours=$_GET['updateid'];
    $sql="select * from `recours` where coderecours=$coderecours";
    $result=mysqli_query($con,$sql);
    $row=mysqli_fetch_assoc($result);

    $etudiant_inscri=$row['refetudiant_inscrit'];
    $cours=$row['refcours'];
    $motif=$row['motif'];
    $date_recours=$row['date_recours'];

    if(isset($_POST['updaterecours'])){
        $etudiant_inscri=$_POST['refetudiant'];
        $cours=$_POST['refcours'];
        $motif=$_POST['motif'];
        $date_recours=$_POST['date'];
        $sql=" UPDATE `recours` SET `coderecours`='$coderecours',`refetudiant_inscrit`=' $etudiant_inscri',`refcours`=' $cours',`motif`='$motif',`date_recours`=' $date_recours' WHERE `coderecours`='$coderecours'";
        $result=mysqli_query($con,$sql);
        if($result){
            echo "date update";
                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="page-header">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h3 class="page-title">Update Recours</h3>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="bank-inner-details">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="field-1" class="form-label">Etudiant</label>
                                                <?php
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="field-1" class="form-label">Cours</label>
                                                <?php
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="field-1" class="form-label">Date</label>
                                                <input type="date" name="date" class="form-control" id="field-1" value=<?php echo $date_recours; ?>>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                                <label for="field-1" class="form-label">Motif</label>
                                                <textarea name="motif" id="field-1" cols="30" rows="10" placeholder="tapez votre motif" class="form-control" value=<?php echo$motif; ?>></textarea>
                                        </div>
                                    </div>
                                    <button type="submit" name="updaterecours" class="btn btn-success">Update</button>
                                    </form>
                                </div>
                            </div>
                        </div>
