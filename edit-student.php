...
<div class="col-12">
    <div class="student-submit">
        <button type="submit" class="btn btn-success" name="update_student">update student</button>
    </div>
</div><br><br><br>
...
<div class="col-12 col-sm-4">
    <div class="form-group students-up-files">
        ...
        <div class="uplod">
            <label class="file-upload image-upbtn mb-0" name="photo">Choose File <input type="file" name="image"></label>
        </div>
    </div>
</div>
