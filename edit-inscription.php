...
if (isset($_POST['updateinscription'])) {
    ...
    $sql = "UPDATE `inscription` SET `idinscription`='$idinscription',`refetudiant`=$refetudiant,`refpromotion`=$refpromotion,`dateinscription`=$dateinscription,`refannee`=$refannee WHERE `idinscription`= '$idinscription'";
    $result = mysqli_query($con, $sql);
    if ($result) {
        echo "data update";
        header('location:tinscription.php');
    } else {
...
<div class="col-md-6">
        ...
        <label for="field-3" class="form-label">Etudiant</label>
            ...
            <select name="refetudiant" id="refetudiant" class="form-control">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ?>
                            <option value= "<?php echo $row["codeetudiant"]; ?>" ><?php echo $row["nom"]; ?> </option>;
                        <?php
                }
                ?>                                     
            </select>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="dateinscription" name="dateinscription" value=<?php echo $dateinscription;?>>
        </div>
    </div>
</div>
<button type="submit" name="updateinscription" class="btn btn-info waves-effect waves-light"> update inscription</button>
</form>
</div>
</div>
</div>
