...
<a href="listeetudiant.php" class="btn btn-outline-primary me-2"><i class="fas fa-download"></i> Download</a>
    ...
    <?php
          ...
          if($result){
              while($row=mysqli_fetch_array($result)){
                  ...
                  <td>'.$numero.'</td>
                  <td>
                  <a href="student-details.php?selectid='.$codeetudiant.'" class="btn btn-sm bg-success-light me-2">
                      <i class="feather-eye"></i>
                  </a>
                  <button  class="btn btn-primary"> <a href="edit-student.php?
                  updateid='.$codeetudiant.'" class="text-light"><i class="feather-edit"></i></a> </button>
                  <button class="btn btn-danger"name="danger"> <a href="deleteStu.php?
                  deletedid='.$codeetudiant.'" class="text-light"><i class="feather-delete"></i></a> </button>
                  </td>
                  </tr>';
              }
