...
if($_GET['printed']&&!empty($_GET['printed'])){
  ...
  $sql = 'SELECT * FROM enseignant WHERE  codeenseignant=:printed';
...
<table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;width:100%;height:286px;position:relative;">
	...
	<tr style="vertical-align:top;">
		...
		<td class="csC0BC38F" colspan="13" style="width:321px;height:22px;line-height:15px;text-align:center;vertical-align:top;"><nobr>CARTE&nbsp;POUR SURVEILLANT &nbsp;|&nbsp;STUDENT&nbsp;IDENTITY&nbsp;CARD</nobr></td>
      ...
      <div class="container" style="display: flex ;margin-top:-140px;">
          <div classe="row" style="font-size: 18px;">
            <div class="col-md-10">
                ...
                <p id="objetm" style="font-size:15px">Matricule | Roll number &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : 
                        <span style="font-weight: bold;">'.$row['codeenseignant'].'</span></p>
                <p id="objetm" style="font-size:15px">Nom  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : 
                        <span style="font-weight: bold;">'.$row['nom'].'</span></p>
                <p id="objetm" style="font-size:15px">Postnom &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : 
                        <span style="font-weight: bold;">'.$row['postnom'].'</span></p>
                <p id="dure" style="font-size:15px">Prenom &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : 
                        <span style="font-weight: bold;">'.$row['prenom'].'</span></p>
                <p id="zone" style="font-size:15px">Mail &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: 
                      <span style="font-weight: bold; ">'.$row['mail'].'</span></p>
        </div>
        </div>
        <div class col-md-2>
        <p style="justify-content: center;text-align: center;align-items: center;">Laisser passer<br><span style="font-weight: bold;font-size:8px;color:red;">Les autorités tant civiles, militaires que celles de la Police 
                    Nationale Congolaise sont priées de leur apporter assistance au porteur de la présente en cas de besoin</span></p>
        </div>
        </div>
</body>
</html>';
