...
<?php
    ...
    $codeannee=$_GET['updateid'];
    $sql="select * from `annee` where codeannee=$codeannee";
    $result=mysqli_query($con,$sql);
    $row=mysqli_fetch_assoc($result);

    $designation= $row['designation'];

    if(isset($_POST['updateannee'])){
        $designation=$_POST['designation'];
        $sql=" UPDATE `annee` SET `codeannee`='$codeannee',`designation`='$designation' WHERE `codeannee`='$codeannee'";
        $result=mysqli_query($con,$sql);
        if($result){
          echo "data update";
...
<button type="submit" name="updateannee" class="btn btn-info waves-effect waves-light"> Update annee</button>
</form>
