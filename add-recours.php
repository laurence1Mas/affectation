...
<?php
    ...
    if(isset($_POST['addrecours'])){
        $etudiant_inscri=$_POST['refetudiant'];
        $cours=$_POST['refcours'];
        $motif=$_POST['motif'];
        $date_recours=$_POST['date'];
        $sql=" INSERT INTO `recours`( `refetudiant_inscrit`, `refcours`, `motif`, `date_recours`) VALUES ('$etudiant_inscri','$cours','$motif','$date_recours')";
                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="page-header">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h3 class="page-title">Add Recours</h3>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="date" class="form-control" id="field-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                                <label for="field-1" class="form-label">Motif</label>
                                                <textarea name="motif" id="field-1" cols="30" rows="10" placeholder="tapez votre motif" class="form-control"></textarea>
                                        </div>
                                    </div>
                                    <button type="submit" name="addrecours" class="btn btn-success">Envoyer</button>
                                    </form>
                                </div>
                            </div>
                        </div>
