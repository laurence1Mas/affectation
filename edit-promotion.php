...
<?php
    ...
    $codepromotion=$_GET['updateid'];
    $sql="select * from `promotion` where codepromotion=$codepromotion";
    ...
    if(isset($_POST['updatepromotion'])){
        ...
        $sql=" UPDATE `promotion` SET `codepromotion`='$codepromotion',`designation`='$designation',`refOption`='$option' WHERE `codepromotion`='$codepromotion'";
        $result=mysqli_query($con,$sql);
        if($result){
          echo "data update";
...
<div class="row">
    <div class="col-md-12">
        <div class="mb-3">
            ...
            <input type="text" name="designation" class="form-control" id="field-3" placeholder="description" value=<?php echo $designation; ?>>
        </div>
    </div>
</div>
<div class="row">
...
<button type="submit" name="updatepromotion" class="btn btn-info waves-effect waves-light"> update Promotion</button>
</form>
