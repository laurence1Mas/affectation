...
<h4 class="modal-title">Enregistrement Inscription</h4>
...
<button type="submit" name="addinscription" class="btn btn-info waves-effect waves-light"> Add inscription</button>
</form>
</div>
  ...
  >
    ...
    if ($result) {
        while ($row = mysqli_fetch_array($result)) {
            ...
            $codeinscription = $row['codeinscription'];
            ...
            echo '<tr> 
                  ...
                  <button class="btn btn-secondary"name="danger"> <a href="carte.php?
