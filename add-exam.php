...
<?php
    ...
    if(isset($_POST['addexamen'])){
        ...
        $sql=" INSERT INTO `examen`(`refcours`, `date_examen`, `heure`, `refsession`, `ponderation`) VALUES ('$cours','$date','$heure','$session','$ponderation')";
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="ponderation" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <label>Date</label>
                                                <input name="date-examen" type="date" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-12">
                                            <button name="addexamen" type="submit" class="btn btn-success">Add examen</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
