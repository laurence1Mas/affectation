...
$codecotation=$_GET['updateid'];
    $sql="select * from `cotation` where codecotation=$codecotation";
    $result=mysqli_query($con,$sql);
    $row=mysqli_fetch_assoc($result);


    $refetudiant = $row['refetudiant'];
    $refcours = $row['refcours'];
    $reftypecote= $row['reftypecote'];
    $pointobtenu= $row['pointobtenu'];

if (isset($_POST['updatecotation'])) {
    $refetudiant = $_POST['refetudiant'];
    $refcours = $_POST['refcours'];
    $reftypecote= $_POST['reftypecote'];
    $pointobtenu= $_POST['pointobtenu'];
    $sql="UPDATE `cotation` SET `codecotation`='$codecotation',`refinscription`='$refetudiant',`refcours`='$refcours',`reftypecote`='$reftypecote',`pointobtenu`=' $pointobtenu' WHERE `codecotation`='$codecotation'";
    $result = mysqli_query($con, $sql);
    if ($result) {
        echo "data update";
...
<div class="col-md-6">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="pointObteneu" name="pointobtenu" value=<?php echo $pointobtenu; ?>>
        </div>
    </div>
</div>
<button type="submit" name="updatecotation" class="btn btn-info waves-effect waves-light"> Update cotation</button>
</form>
