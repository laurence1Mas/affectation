...
<?php
    ...
    $codeexamen=$_GET['updateid'];
    $sql="select * from `examen` where codeexamen=$codeexamen";
    ...
    $heure=$row['heure'];
    $session=$row['refsession'];

    if(isset($_POST['updateexamen'])){
        $cours=$_POST['refcours'];
        $ponderation=$_POST['ponderation'];
        $date=$_POST['date-examen'];
        $heure=$_POST['heure'];
        $session=$_POST['refsession'];
        $sql=" UPDATE `examen` SET `codeexamen`='$codeexamen',`refcours`='$cours',`ponderation`='$ponderation',`date_examen`='$date',`heure`='$heure',`refsession`='$session' WHERE `codeexamen`='$codeexamen'";
        $result=mysqli_query($con,$sql);
        if($result){
          echo "data update";
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="post">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="form-title"><span>Exam Update</span></h5>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <?php
                                                    ...
                                                    $row=mysqli_fetch_assoc($result);
                                                ?>
                                                <select name="refcours" class="form-control select">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="ponderation" class="form-control" value=<?php echo $ponderation;?>>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <label>Date</label>
                                                <input name="date-examen" type="date" class="form-control" value=<?php echo $date;?>>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <label>Heure</label>
                                                <input name="heure" type="time" class="form-control" value=<?php echo $heure;?>>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                            ...
                                            <?php
                                                    ...
                                                    $row=mysqli_fetch_assoc($result);
                                                ?>
                                                <select name="refsession" class="form-control select">
                                                    <option>Select session</option>
                                                    <?php
                                                        while($row=mysqli_fetch_assoc($result))
                                                        {
                                                    ?>
                                                    <option value="<?php echo $row["codesession"];?>"><?php echo $row["designation"];?></option>
                                                    <?php
                                                        }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="col-12">
                                            <button name="updateexamen" type="submit" class="btn btn-success">update examen</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
