...
<?php
    ...
    if(isset($_POST['addsalle'])){
        ...
        $range=$_POST['nbr-range'];
        $place=$_POST['nbr-place'];
  
        $sql=" INSERT INTO `salle`( `designation`,`nbr_range`,`nbr_place`) VALUES ('$designation','$range','$place')";
...
<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="students.html">Salle</a></li>
<li class="breadcrumb-item active">All Salle</li>
</ul>
</div>
</div>
</div>
...
<h4 class="modal-title">Enregistrement salle</h4>
...
<div class="row">
    <div class="col-md-12">
        <div class="mb-3">
            ...
            <input type="text" name="designation" class="form-control" id="field-3" placeholder="description">
        </div>
    </div>
</div>
<div class="row">
<div class="col-md-6">
    <div class="mb-3">
        <label for="field-1" class="form-label">Nombre range</label>
        <input type="text" name="nbr-range" class="form-control" id="field-1" placeholder="nombre range">
    </div>
</div>
<div class="col-md-6">
    <div class="mb-3">
        <label for="field-2" class="form-label">Nonbre place</label>
        <input type="text" name="nbr-place" class="form-control" id="field-2" placeholder="nombre place">
    </div>
</div>
</div>
<button type="submit" name="addsalle" class="btn btn-info waves-effect waves-light"> Add salle</button>
</form>
</div>
...
<div class="table-responsive">
  ...
  >
    <thead class="student-thread">
      ...
      <th scope="col">nombre-range</th>
      <th scope="col">nombr-place</th>
    ...
    <?php
          ...
          if($result){
              while($row=mysqli_fetch_array($result)){
                ...
                $nbr_range=$row['nbr_range'];
                $nbr_place=$row['nbr_place'];
                  echo '<tr>
                  <th scope="row">'.$codesalle.'</th>
                  <td>'.$designation.'</td>
                  <td>'.$nbr_range.'</td>
                  <td>'.$nbr_place.'</td>
                  <td>
                  <a href="student-details.php?selectid='.$codesalle.'" class="btn btn-sm bg-success-light me-2">
                      <i class="feather-eye"></i>
                  </a>
                  <button  class="btn btn-primary"> <a href="edit-salle.php?
                  updateid='.$codesalle.'" class="text-light"><i class="feather-edit"></i></a> </button>
                  <button class="btn btn-danger"name="danger"> <a href="deleteSalle.php?
                  deletedid='.$codesalle.'" class="text-light"><i class="feather-delete"></i></a> </button>
                  </td>
                  </tr>';
              }
