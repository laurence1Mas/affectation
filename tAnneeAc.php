...
<?php
    ...
    if(isset($_POST['addannee'])){
        $designation=$_POST['designation'];
  
        $sql=" INSERT INTO `annee`( `designation`) VALUES ('$designation')";
...
<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="students.html">Annee</a></li>
<li class="breadcrumb-item active">All AnneeAC</li>
</ul>
</div>
</div>
</div>
...
<div class="col">
<h3 class="page-title">Annee Academique</h3>
</div>
...
<h4 class="modal-title">Enregistrement AnneeAc</h4>
...
<button type="submit" name="addannee" class="btn btn-info waves-effect waves-light"> Add annee</button>
</form>
</div>
    ...
    <?php
          ...
          if($result){
              while($row=mysqli_fetch_array($result)){
                $codeannee=$row ['codeannee'];
                $designation=$row['designation'];
                  echo '<tr>
                  <th scope="row">'.$codeannee.'</th>
                  <td>'.$designation.'</td>
                  <td>
                  <a href="student-details.php?selectid='.$codeannee.'" class="btn btn-sm bg-success-light me-2">
                        <i class="feather-eye"></i>
                  </a>
                  <button  class="btn btn-primary"> <a href="edit-annee.php?
                  updateid='.$codeannee.'" class="text-light"><i class="feather-edit"></i></a> </button>
                  <button class="btn btn-danger"name="danger">   <a href="deleteAnnee.php?
                  deletedid='.$codeannee.'" class="text-light"><i class="feather-delete"></i></a>   </button>
                  </td>
                  </tr>';
              }
          }
