...
if (isset($_POST['addinscription'])) {
    ...
    $sql = " call insert_etudiant_inscrit ('$refetudiant','$refpromotion','$refannee')";
...
<div class="col-md-6">
    <div class="mb-3">
        <label for="field-3" class="form-label">surveillant</label>
            <?php
            ...
            <select name="refetudiant" id="refetudiant" class="form-control">
                <option >select surveillant ---</option>
                <?php
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <label for="dateinscription"> Date affectation</label>
            <input type="date" class="form-control" id="dateinscription" name="dateinscription">
        </div>
    </div>
</div>
<button type="submit" name="addinscription" class="btn btn-info waves-effect waves-light"> Add Affectation</button>
</form>
</div>
...
<div class="table-responsive">
  ...
  >
    <thead class="student-thread">
      ...
      <th scope="col">Idunique</th>
      <th scope="col">Actions</th>
      </tr>
    </thead>
    <tbody>
    <?php
    $sql = "SELECT * FROM `attribution_place_examen`";
    $result = mysqli_query($con, $sql);
    if ($result) {
        while ($row = mysqli_fetch_array($result)) {
            $idinscription= $row['ID'];
            $codeinscription = $row['INSCRIPTION'];
            $promotion= $row['SALLE'];
            $DATE=$row['DATE'];
            $ID=$row['IDUNIQUEIDENTITY'];
            echo '<tr>
                  ...
                  <button class="btn btn-secondary"name="danger"> <a href="carteetudiant.php?
