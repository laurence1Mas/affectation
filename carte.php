...
if($_GET['printed']&&!empty($_GET['printed'])){
  ...
  $sql = 'SELECT * FROM vinscription WHERE  idinscription=:printed';
          ...
          <div classe="row" style="font-size: 18px;">
            <div class="col-md-10">
                ...
                <p id="objetm" style="font-size:15px">Matricule | Roll number &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : 
                        <span style="font-weight: bold;">'.$row['codeinscription'].'</span></p>
                <p id="objetm" style="font-size:15px">Nom & Postnom & Prenom &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : 
                        <span style="font-weight: bold;">'.$row['etudiant'].'</span></p>
                <p id="objetm" style="font-size:15px">Filiere d\'etude | Study pogram &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : 
                        <span style="font-weight: bold;">'.$row['options'].'</span></p>
                <p id="dure" style="font-size:15px">Promotion | class &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : 
                        <span style="font-weight: bold;">'.$row['promotion'].'</span></p>
                <p id="zone" style="font-size:15px">Annee academique  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: 
                      <span style="font-weight: bold; ">'.$row['anneeAC'].'</span></p>
        </div>
        </div>
        <div class col-md-2>
