...
<?php
    ...
    if(isset($_POST['addsession'])){
        ...
        $sql=" INSERT INTO `session`( `designation`) VALUES ('$designation')";
...
<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="students.html">session</a></li>
...
<h4 class="modal-title">Enregistrement Session</h4>
...
<button type="submit" name="addsession" class="btn btn-info waves-effect waves-light"> Add session</button>
</form>
</div>
    ...
    <?php
          ...
          if($result){
              while($row=mysqli_fetch_array($result)){
                $codesession=$row ['codesession'];
                $designation=$row['designation'];
                  echo '<tr>
                  <th scope="row">'.$codesession.'</th>
                  <td>'.$designation.'</td>
                  <td>
                  <a href="student-details.php?selectid='.$codesession.'" class="btn btn-sm bg-success-light me-2">
                      <i class="feather-eye"></i>
                  </a>
                  <button  class="btn btn-primary"> <a href="edit-session.php?
                  updateid='.$codesession.'" class="text-light"><i class="feather-edit"></i></a> </button>
                  <button class="btn btn-danger"name="danger"> <a href="deleteSession.php?
                  deletedid='.$codesession.'" class="text-light"><i class="feather-delete"></i></a> </button>
                  </td>
                  </tr>';
              }
