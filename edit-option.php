...
<?php
    ...
    $codeoption=$_GET['updateid'];
    $sql="select * from `option` where codeoption=$codeoption";
    ...
    if(isset($_POST['updateoption'])){
        ...
        $sql="UPDATE `option` SET `codeoption`='$codeoption',`designation`='$designation' WHERE `codeoption`='$codeoption'";
        $result=mysqli_query($con,$sql);
        if($result){
          echo "data insert";
...
<button type="submit" name="updateoption" class="btn btn-info waves-effect waves-light"> Update option</button>
</form>
