...
$codecours=$_GET['updateid'];
    $sql="select * from `cours` where codecours=$codecours";
    $result=mysqli_query($con,$sql);
    $row=mysqli_fetch_assoc($result);

$designation=$row['designation'];
$enseignant=$row['refenseignant'];
$promotion=$row['refpromotion'];
$ponderation=$row['ponderation'];
$nbr_heure=$row['nbr_heure'];
...
if(isset($_POST['updatecours'])){
    ...
    $sql="UPDATE `cours` SET `codecours`='$codecours',`designation`='$designation',`refenseignant`='$enseignant',`refpromotion`='$promotion',`ponderation`='$ponderation',`nbr_heure`='$nbr_heure' WHERE `codecours`='$codecours'";
    $result=mysqli_query($con,$sql);
    if($result){
        echo "data update";
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="post">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="form-title"><span>Cours Update</span></h5>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Designation<span class="login-danger">*</span></label>
                                                <input type="text" class="form-control" name="designation" values=<?php echo $designation;?>>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms ">
                                                ...
                                                <input class="form-control" type="text" name="ponderation" values=<?php echo $ponderation; ?>>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Nombre heure <span class="login-danger">*</span></label>
                                                <input type="text" class="form-control" name="nbr-heure" values=<?php echo $nbr_heure; ?>>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="student-submit">
                                                <button type="submit" class="btn btn-success" name="updatecours">Update Cours</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
