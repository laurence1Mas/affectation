...
<?php
    ...
    if(isset($_POST ['addstudent'])){
      ...
      $mail =$_POST['email'];
      $photo=$_POST['photo'];
      $sql=" INSERT INTO `etudiant`( `photo`, `nom`, `postnom`, `prenom`, `genre`, `etat_civil`, `lieu_naissance`, `date_naissance`, `nom_pere`, `nom_mere`, `adresse`, `numero`, `mail`) values ('$photo','$name','$postnom','$prenom','$genre','$etat_civil','$lieu_naissance',
      '$date_naissance','$nom_pere','$nom_mere','$adresse','$numero','$mail')";
...
<div class="col-12">
    <div class="student-submit">
        <button type="submit" class="btn btn-success" name="addstudent">Add student</button>
    </div>
</div><br><br><br>
...
<div class="col-12 col-sm-4">
    <div class="form-group local-forms">
        ...
        <input class="form-control" name="lieu-naissance" type="text" placeholder="entrer le lieu de naissance">
    </div>
</div>
<div class="col-12 col-sm-4">
    <div class="form-group local-forms">
...
<div class="col-12 col-sm-4">
    <div class="form-group local-forms">
        ...
        <input class="form-control" name="nom-pere" type="text" placeholder="entre le nom du pere">
    </div>
</div>
<div class="col-12 col-sm-4">
    <div class="form-group local-forms">
        <label>Nom de la mere</label>
        <input class="form-control" name="nom-mere" type="text" placeholder="entre le nom dela mere">
    </div>
</div>
<div class="col-12 col-sm-4">
    <div class="form-group local-forms">
