...
<?php
    ...
    if(isset($_POST['addoption'])){
        ...
        $sql=" INSERT INTO `option`( `designation`) VALUES ('$designation')";
...
<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="students.html">Option</a></li>
...
<h4 class="modal-title">Enregistrement Option</h4>
...
<button type="submit" name="addoption" class="btn btn-info waves-effect waves-light"> Add option</button>
</form>
</div>
    ...
    <?php
          ...
          if($result){
              while($row=mysqli_fetch_array($result)){
                  $codeoption=$row ['codeoption'];
                  $designation=$row['designation'];
                  echo '<tr>
                  <th scope="row">'.$codeoption.'</th>
                  <td>'.$designation.'</td>
                  <td>
                  <a href="student-details.php?selectid='.$codeoption.'" class="btn btn-sm bg-success-light me-2">
                      <i class="feather-eye"></i>
                  </a>
                  <button  class="btn btn-primary"> <a href="edit-option.php?
                  updateid='.$codeoption.'" class="text-light"><i class="feather-edit"></i></a> </button>
                  <button class="btn btn-danger"name="danger"> <a href="deleteOption.php?
                  deletedid='.$codeoption.'" class="text-light"><i class="feather-delete"></i></a> </button>
                  </td>
                  </tr>';
              }
