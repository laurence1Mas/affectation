...
<?php
    ...
    $codesalle=$_GET['updateid'];
    $sql="select * from `salle` where codesalle=$codesalle";
    ...
    if(isset($_POST['Updatesalle'])){
        $designation=$_POST['designation'];
        $range=$_POST['nbr-range'];
        $place=$_POST['nbr-place'];
  
        $sql=" UPDATE `salle` SET `codesalle`='$codesalle',`designation`='$designation',`nbr_range`='$range',`nbr_place`='$place' WHERE `codesalle`='$codesalle'";
        $result=mysqli_query($con,$sql);
        if($result){
          echo "data update";
...
<div class="col-md-6">
    <div class="mb-3">
        ...
        <input type="text" name="nbr-range" class="form-control" id="field-1" placeholder="nombre range" value=<?php echo $range;?>>
    </div>
</div>
<div class="col-md-6">
    <div class="mb-3">
        <label for="field-2" class="form-label">Nonbre place</label>
        <input type="text" name="nbr-place" class="form-control" id="field-2" placeholder="nombre place" value=<?php echo $place;?>>
    </div>
</div>
</div>
<button type="submit" name="Updatesalle" class="btn btn-info waves-effect waves-light"> Update salle</button>
</form>
