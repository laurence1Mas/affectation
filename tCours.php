...
<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="students.html">Cours</a></li>
<li class="breadcrumb-item active">All Cours</li>
</ul>
</div>
</div>
</div>
...
<a href="add-cours.php" class="btn btn-primary"><i class="fas fa-plus"></i></a>
          ...
          if($result){
              while($row=mysqli_fetch_array($result)){
                ...
                $nbr_heure=$row['nbr_heure'];
                  ...
                  <td>'.$nbr_heure.'</td>
                  <td>
                  <a href="student-details.php?selectid='.$codecours.'" class="btn btn-sm bg-success-light me-2">
                      <i class="feather-eye"></i>
                  </a>
                  <button  class="btn btn-primary"> <a href="edit-cours.php?
                  updateid='.$codecours.'" class="text-light"><i class="feather-edit"></i></a> </button>
                  <button class="btn btn-danger"name="danger"> <a href="deleteCours.php?
                  deletedid='.$codecours.'" class="text-light"><i class="feather-delete"></i></a> </button>
                  </td>
                  </tr>';
              }
