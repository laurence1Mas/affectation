...
<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="students.html">Examen</a></li>
<li class="breadcrumb-item active">All Examen</li>
</ul>
</div>
</div>
</div>
...
<a href="horaire.php" class="btn btn-outline-primary me-2"><i class="fas fa-download"></i> Download</a>
<a href="add-exam.php" class="btn btn-outline-primary me-2"><i class="fas fa-plus"></i></a>
          ...
          if($result){
              while($row=mysqli_fetch_array($result)){
                ...
                $session=$row['sessions'];
                  ...
                  <td>'.$session.'</td>
                  <td>
                  <a href="student-details.php?selectid='.$codeexamen.'" class="btn btn-sm bg-success-light me-2">
                      <i class="feather-eye"></i>
                  </a>
                  <button  class="btn btn-primary"> <a href="edit-examen.php?
                  updateid='.$codeexamen.'" class="text-light"><i class="feather-edit"></i></a> </button>
                  <button class="btn btn-danger"name="danger"> <a href="deleteexamen.php?
                  deletedid='.$codeexamen.'" class="text-light"><i class="feather-delete"></i></a> </button>
                  </td>
                  </tr>';
              }
