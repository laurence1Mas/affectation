...
<?php
    ...
    $codeetudiant=$_GET['selectid'];
    $sql="select * from `etudiant` where codeetudiant=$codeetudiant";
    $result=mysqli_query($con,$sql);
    $row=mysqli_fetch_assoc($result);

    //========================les variables pour recuperer les donnee enregistrer======================
        $name =$row['nom'];
        $postnom =$row['postnom'];
        $prenom =$row['prenom'];
        $genre =$row['genre'];
    ...
    /*========================= condition pour checker les donnees================================ */
    if(isset($_POST ['update_student'])){
      ...
      $nom_pere =$_POST['nom-pere'];
      $nom_mere =$_POST['nom-mere'];
      $adresse =$_POST['adresse'];
      $numero =$_POST['numero'];
      $mail=$_POST['email'];

      $sql=" UPDATE `etudiant` SET `codeetudiant`='$codeetudiant',`nom`='$name',`postnom`='$postnom',`prenom`='$prenom',`genre`='$genre',`etat_civil`='$etat_civil',`lieu_naissance`='$lieu_naissance',`date_naissance`='$date_naissance',`nom_pere`='$nom_pere',`nom_mere`='$nom_mere',`adresse`='$adresse',`numero`='$numero',`mail`='$mail' WHERE `codeetudiant`='$codeetudiant'";
      $result=mysqli_query($con,$sql);
...
<h3 class="page-title">details Students</h3>
<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="students.html">Student</a></li>
<li class="breadcrumb-item active">details Students</li>
</ul>
</div>
</div>
</div>
...
<div class="col-12">
    <div class="student-submit">
        <button type="submit" class="btn btn-success" name="detail_student">details student</button>
    </div>
</div><br><br><br>
<div class="col-12 col-sm-4">
    <div class="form-group local-forms">
        <label>Nom <span class="login-danger">*</span></label>
        <input id="nom" class="form-control" name="name" type="text" value=<?php echo $name;?> />
    </div>
</div>
<div class="col-12 col-sm-4">
    <div class="form-group local-forms">
        <label>postnom <span class="login-danger">*</span></label>
        <input class="form-control" name="postnom" type="text"  value=<?php echo $postnom;?> />
    </div>
</div>
<div class="col-12 col-sm-4">
    <div class="form-group local-forms">
...
<div class="col-12 col-sm-4">
    <div class="form-group local-forms">
        ...
        <input class="form-control" name="lieu-naissance" type="text" value=<?php echo $lieu_naissance ;?>/>
    </div>
</div>
<div class="col-12 col-sm-4">
    <div class="form-group local-forms calendar-icon">
        <label>Date de naissance <span class="login-danger">*</span></label>
        <input class="form-control datetimepicker" name="date-naissance" type="date" value=<?php echo $date_naissance ;?>/>
    </div>
</div>
<div class="col-12 col-sm-4">
    <div class="form-group local-forms">
        <label>Nom du pere</label>
        <input class="form-control" name="nom-pere" type="text" value=<?php echo $nom_pere ;?>/>
    </div>
</div>
<div class="col-12 col-sm-4">
    <div class="form-group local-forms">
        <label>Nom de la mere</label>
        <input class="form-control" name="nom-mere" type="text" value=<?php echo $nom_mere ;?>/>
    </div>
</div>
<div class="col-12 col-sm-4">
    <div class="form-group local-forms">
...
<div class="col-12 col-sm-4">
    <div class="form-group local-forms">
        ...
        <input class="form-control" name="numero" type="text" value <?php echo $numero ;?>/>
    </div>
</div>
<div class="col-12 col-sm-4">
    <div class="form-group local-forms">
        <label>E-Mail <span class="login-danger">*</span></label>
        <input class="form-control" name="email" type="text"  value <?php echo $mail ;?>/>
    </div>
</div>
<div class="col-12 col-sm-4">
