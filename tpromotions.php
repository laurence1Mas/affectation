...
<?php
    ...
    if(isset($_POST['addpromotion'])){
        ...
        $option=$_POST['refoption'];
        $sql=" INSERT INTO `promotion`( `designation`,`refoption`) VALUES ('$designation','$option')";
                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu active">
                            <a href="index.php"><i class="feather-grid"></i> <span> Dashboard</span> <span
...
<a href="tpromotions.php" class="btn btn-outline-gray me-2 active"><i class="feather-list"></i></a>
<a href="tpromotions.php" class="btn btn-outline-gray me-2"><i class="feather-grid"></i></a>
...
<h4 class="modal-title">Enregistrement Promotion</h4>
...
<div class="col-md-12">
        <div class="mb-3">
            <label for="field-3" class="form-label">Option</label>
            <?php
                $sql="select * from `options`";
                $result=mysqli_query($con,$sql);
                $row=mysqli_fetch_assoc($result);
            ?>
            <select name="refoption" id="refoption" class="form-control">
...
<button type="submit" name="addpromotion" class="btn btn-info waves-effect waves-light"> Add Promotion</button>
</form>
</div>
...
<div class="table-responsive">
  ...
  >
    ...
    <tbody>
    <?php
           $sql="SELECT * FROM `vpromotion`";
           $result=mysqli_query($con,$sql);
          if($result){
              while($row=mysqli_fetch_array($result)){
                $codepromotion=$row ['codepromotion'];
                $designation=$row['designation'];
                $option=$row['refoption'];
                  echo '<tr>
                  <th scope="row">'.$codepromotion.'</th>
                  <td>'.$designation.'</td>
                  <td>'.$option.'</td>
                  <td>
                  <a href="student-details.php?selectid='.$codepromotion.'" class="btn btn-sm bg-success-light me-2">
                      <i class="feather-eye"></i>
                  </a>
                  <button  class="btn btn-primary"> <a href="edit-promotion.php?
                  updateid='.$codepromotion.'" class="text-light"><i class="feather-edit"></i></a> </button>
                  <button class="btn btn-danger"name="danger"> <a href="deletePromotion.php?
                  deletedid='.$codepromotion.'" class="text-light"><i class="feather-delete"></i></a> </button>
                  </td>
                  </tr>';
              }
