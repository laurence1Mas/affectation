                    ...
                    <ul>
                        ...
                        <li class="submenu active">
                            ...
                            <ul>
                                ...
                                <li><a href="tattributionplaceetudiant.php" class="active">ATTRIBUTION</a></li>
                            </ul>
                        </li>
                        <li class="submenu">
                        ...
                        <div class="card bg-comman w-100">
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                                        <h6>etudiants</h6>
                                        <?php $sql = "SELECT *from inscription;";
