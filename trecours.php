...
<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="students.html">Recours</a></li>
<li class="breadcrumb-item active">All Recours</li>
</ul>
</div>
</div>
</div>
...
<a href="add-recours.php" class="btn btn-primary"><i class="fas fa-plus"></i></a>
...
<div class="table-responsive">
  ...
  >
    <thead class="student-thread">
      ...
      <th scope="col">date-recours</th>
      </tr>
    </thead>
    <tbody>
    <?php
           $sql="select * from `vrecours`";
           $result=mysqli_query($con,$sql);
          if($result){
              while($row=mysqli_fetch_array($result)){
                $coderecours=$row ['coderecours'];
                $etudiant_inscrit=$row['etudiant'];
                $cours=$row['cours'];
                $motif=$row['motif'];
                $date=$row['date_recours'];
                  echo '<tr>
                  <th scope="row">'.$coderecours.'</th>
                  <td>'.$etudiant_inscrit.'</td>
                  <td>'.$cours.'</td>
                  <td>'.$motif.'</td>
                  <td>'.$date.'</td>
                  <td>
                  <a href="student-details.php?selectid='.$coderecours.'" class="btn btn-sm bg-success-light me-2">
                      <i class="feather-eye"></i>
                  </a>
                  <button  class="btn btn-primary"> <a href="edit-recours.php?
                  updateid='.$coderecours.'" class="text-light"><i class="feather-edit"></i></a> </button>
                  <button class="btn btn-danger"name="danger"> <a href="deleterecours.php?
                  deletedid='.$coderecours.'" class="text-light"><i class="feather-delete"></i></a> </button>
                  </td>
                  </tr>';
              }
          }
