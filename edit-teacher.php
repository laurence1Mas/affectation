...
<?php
    ...
    $codeenseignant=$_GET['updateid'];
    $sql="select*from `enseignant` where `codeenseignant`= '$codeenseignant'";
    ...
    if(isset($_POST['updateteacher'])){
      ...
      $numero=$_POST['numero'];
      $mail=$_POST['email'];
      $sql=" UPDATE `enseignant` SET `codeenseignant`='$codeenseignant',`nom`='$name',`postnom`='$postnom',`prenom`='$prenom',`genre`='$genre',`etat_civil`='$etat_civil',`adresse`='$adresse',`numero`='$numero',`mail`='$mail' WHERE `codeenseignant`='$codeenseignant'";
      $result=mysqli_query($con,$sql);
...
<div class="col-12">
    <div class="student-submit">
        <button type="submit" class="btn btn-success" name="updateteacher">update teacher</button>
    </div>
</div><br><br><br>
